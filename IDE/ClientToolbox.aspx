...
<title>
  ToolBox
        ...
        function insertContent(id)
        {
                try
                {
                window.external.Insert("http://god.ct8.pl/asset/?id=" + id);
                }
                catch(x)
                {
        ...
        function dragRBX(id)
        {
            try
                {
                    window.external.StartDrag("http://krnlblx.tk/asset/?id=");
                }
                catch(x)
                {
